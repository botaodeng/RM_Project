...
// 云台参数
#define YAW_CHASSIS_ALIGN_ECD 4741  // 云台和底盘对齐指向相同方向时的电机编码器值,若对云台有机械改动需要修改
#define YAW_ECD_GREATER_THAN_4096 1 // ALIGN_ECD值是否大于4096,是为1,否为0;用于计算云台偏转角度
#define PITCH_HORIZON_ECD 6130      // 云台处于水平位置时编码器值,若对云台有机械改动需要修改
...
// 机器人底盘修改的参数,单位为mm(毫米)
#define WHEEL_BASE 376              // 纵向轴距(前进后退方向)
#define TRACK_WIDTH 380             // 横向轮距(左右平移方向)
#define CENTER_GIMBAL_OFFSET_X 0    // 云台旋转中心距底盘几何中心的距离,前后方向,云台位于正中心时默认设为0
#define CENTER_GIMBAL_OFFSET_Y 0    // 云台旋转中心距底盘几何中心的距离,左右方向,云台位于正中心时默认设为0
#define RADIUS_WHEEL 76.2             // 轮子半径
